...
| # | Risk | Status |
| --- | --- | --- |
| 1 | **The page describes an unbuilt members area in the present tense.** Cultivation offers, my plants, swap zone and subscriptions are named as things membership gives a member; none of the four exists. The softening note was removed on the client's instruction. A visitor who signs up today reaches a members area of inert *Not built yet* tiles. **The sign-up half of this risk has closed** — the form stores a `User`, a `ClubMembership` and a consent per document, and Payfast activates the membership — so what remains is the promise of screens rather than the promise of an account. | **Open — client decision, taken 2026-08-25** |
