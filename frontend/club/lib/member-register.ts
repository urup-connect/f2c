 ...
 * rules a field assignment does not. See `app/club/membership/administration.py`.
 */
...
/*
 * Mirroring the `TextChoices` in `app/core/accounts/models.py` and
 * `app/core/accounts/roles.py`. Written out rather than fetched, for the reason
 ...
 * `app/club/membership/administration.py` is the same set, and the two are written
