 ...
 * resolved from `app/accounts/roles.py`. This module turns that list into things to draw. The role
...
export type ClubDestination = {
   ...
   * `app/accounts/roles.py` — a contract test reads that file and refuses a codename it does not
...
export const CLUB_DESTINATIONS = [
  ...
  },
  {
    ...
    description: 'End a membership and stop what it is billed for.',
    permission: 'platform.cancel_membership',
    section: 'administration',
    state: 'planned',
    href: null,
  },
  ...
  },
  {
    ...
    description: 'Reverse a transaction in whole or in part, withholding fees.',
    permission: 'platform.refund_transaction',
    section: 'administration',
    state: 'planned',
    href: null,
  },
