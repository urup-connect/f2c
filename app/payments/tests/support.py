...
from app.membership import services as membership_services
from app.membership.tests.support import ADULT_ID, RegistrationTestCase
...
class PaymentsTestCase(RegistrationTestCase):
    ...
    def assertStillPendingPayment(self):
        self.member.refresh_from_db()
        self.assertEqual(self.member.status, UserStatus.PENDING_PAYMENT)
